...
function ShippingInfo({distance, duration, map, setship, ship, weight, setweight, totalCost, calculateRoute, clearRoute}) {
    return (
        <div>
            <div className='flex mt-5 wrap bg-white p-2 rounded shadow-md justify-center items-center gap-5'>
            ...
            <select className='border-2 border-gray-300 rounded p-2 mt-6 font-semibold' value={ship} onChange={(e) => setship(e.target.value)}>
